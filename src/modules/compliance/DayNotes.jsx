              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2 text-xs font-semibold rounded-xl transition-all
                    ${isSelected 
                      ? 'bg-brand-55 text-brand-600 dark:bg-brand-950/20 dark:text-brand-400 border border-brand-200 dark:border-brand-900/50' 
            ...
            <div className="space-y-4">
              {filteredNotes.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 text-slate-400 space-y-2">
                  <AlertCircle className="h-10 w-10 text-slate-305" />
