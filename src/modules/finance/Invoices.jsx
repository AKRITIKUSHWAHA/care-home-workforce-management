...
import { FileSpreadsheet, Search, Filter, Download, Plus, ChevronRight, MoreHorizontal, X, FileUp, Edit, Trash2 } from 'lucide-react';

const Invoices = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [formData, setFormData] = useState({ "invoiceId": "", "funder": "", "dateIssued": "", "amount": "", "dueDate": "", status: 'Active' });
  ...
  const handleAddRecord = () => {
    ...
    setFormData({ "invoiceId": "", "funder": "", "dateIssued": "", "amount": "", "dueDate": "", status: 'Active' });
  };
