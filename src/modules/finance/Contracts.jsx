...
import { Briefcase, Search, Filter, Download, Plus, ChevronRight, MoreHorizontal, X, FileUp, Edit, Trash2 } from 'lucide-react';

const Contracts = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [formData, setFormData] = useState({ "funderName": "", "type": "", "baseRate": "", "startDate": "", "document": "", status: 'Active' });
  ...
  {
    "id": "1",
    "funderName": "Local Authority (North)",
    "type": "Commissioned",
    "baseRate": "21.50",
  ...
  {
    "id": "2",
    "funderName": "NHS Continuing Care",
    "type": "Commissioned",
    "baseRate": "24.00",
  ...
  {
    "id": "3",
    "funderName": "Private Self-Funded",
    "type": "Private",
    "baseRate": "25.00",
    "startDate": "2025-01-01",
    "status": "Active"
  ...
  const handleAddRecord = () => {
    ...
    setFormData({ "funderName": "", "type": "", "baseRate": "", "startDate": "", "document": "", status: 'Active' });
  };
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-3xl bg-gradient-to-r from-brand-800 to-brand-600 p-6 md:p-8 text-white shadow-lg shadow-brand-900/10">
        <div>
          ...
          <p className="mt-1 text-sm md:text-base text-brand-100 font-medium">
            Funder contracts, rates, and commissioning details.
          </p>
        </div>
