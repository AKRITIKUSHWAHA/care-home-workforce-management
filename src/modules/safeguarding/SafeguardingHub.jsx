...
import { ShieldAlert, Search, Filter, Download, Plus, ChevronRight, MoreHorizontal, X, FileUp, Edit, Trash2 } from 'lucide-react';

const SafeguardingHub = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [formData, setFormData] = useState({ "caseId": "", "type": "", "reportedBy": "", "date": "", "severity": "", "description": "", status: 'Active' });
  ...
  const [tableData, setTableData] = useState([
  {
    "id": "1",
    "caseId": "SG-26-042",
    "type": "Financial Abuse Suspicion",
  ...
  },
  {
    "id": "2",
    "caseId": "SG-26-043",
    "type": "Unexplained Bruising",
    "reportedBy": "Emma Wilson",
    "date": "2026-06-03",
    "status": "Referred to LA"
  },
  {
    "id": "3",
    "caseId": "SG-26-040",
  ...
  const handleAddRecord = () => {
    ...
    setFormData({ "caseId": "", "type": "", "reportedBy": "", "date": "", "severity": "", "description": "", status: 'Active' });
  };
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-3xl bg-gradient-to-r from-brand-800 to-brand-600 p-6 md:p-8 text-white shadow-lg shadow-brand-900/10">
        <div>
          ...
          <p className="mt-1 text-sm md:text-base text-brand-100 font-medium">
            Central dashboard for concerns, incidents, and reporting.
          </p>
        </div>
...
export default SafeguardingHub;
