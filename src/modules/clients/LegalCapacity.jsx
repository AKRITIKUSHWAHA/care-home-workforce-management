...
import { Scale, Search, Filter, Download, Plus, ChevronRight, MoreHorizontal, X, FileUp, Edit, Trash2 } from 'lucide-react';

const LegalCapacity = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [formData, setFormData] = useState({ "client": "", "assessmentType": "", "dateAuthorised": "", "expiryDate": "", "document": "", status: 'Active' });
  ...
  const [tableData, setTableData] = useState([
  {
    ...
    "assessmentType": "DoLS Standard",
    "dateAuthorised": "2026-01-12",
  ...
  },
  {
    "id": "2",
    "client": "John Taylor",
    "assessmentType": "MCA Form 3",
    "dateAuthorised": "2026-03-05",
  ...
  },
  {
    ...
    "assessmentType": "DoLS Urgent",
    "dateAuthorised": "Pending",
    "expiryDate": "Pending",
    "status": "Pending"
  }
]);
  ...
  const handleAddRecord = () => {
    ...
    setFormData({ "client": "", "assessmentType": "", "dateAuthorised": "", "expiryDate": "", "document": "", status: 'Active' });
  };
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-3xl bg-gradient-to-r from-brand-800 to-brand-600 p-6 md:p-8 text-white shadow-lg shadow-brand-900/10">
        <div>
          ...
          <p className="mt-1 text-sm md:text-base text-brand-100 font-medium">
            Manage mental capacity assessments and Deprivation of Liberty Safeguards.
          </p>
        </div>
