...
templates.forEach(t => {
  const absolutePath = path.join(__dirname, t.file);
...
import { ${t.icon}, Search, Filter, Download, Plus, ChevronRight, MoreHorizontal, X, FileUp, Edit, Trash2 } from 'lucide-react';
